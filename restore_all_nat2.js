...
const FIRST_NAME_MAP = {
  ...
  'Nakamura':'Japan','Yamamoto':'Japan','Sasaki':'Japan','Suzuki':'Japan',
  'Takahashi':'Japan','Tanaka':'Japan','Watanabe':'Japan','Ito':'Japan',
  'Nakamura':'Japan','Kobayashi':'Japan','Kato':'Japan','Yoshida':'Japan',
  'Satoh':'Japan','Yamashita':'Japan','Inoue':'Japan','Kimura':'Japan',
  'Hayashi':'Japan','Shimizu':'Japan','Yamada':'Japan','Saito':'Japan',
};
...
if (stillUnknown.length > 0) console.log('Unknown names:', stillUnknown.join(', '));
