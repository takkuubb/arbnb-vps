...
const FIRST_NAME_MAP = {
  ...
  'Fan':'China','Puttinan':'Thailand','Meri':'Malaysia','Patiphan':'Thailand',
  'Ramiz':'Pakistan','Bryan':'USA','Leuk':'Hong Kong',
  'Nakura':'Japan','Sitanan':'Thailand','Si Weng':'Macau',
  // LAST BATCH
  'Komei':'Japan','Tanchanok':'Thailand','Syazatul':'Malaysia','Wanapa':'Thailand',
  'Adib':'Malaysia','Natra':'Indonesia','Ngai':'Macau',
  'Sze':'Hong Kong',
};
...
console.log('Total:', total.c, '| With nationality:', withNat.c);
